<template>
  <div class="footer">
    ...
    <div class="footer__app footer-app">
      <div class="footer-app__img"><img src="static/icons/app.jpg" alt="Скачать приложение"></div>
      <div class="footer-app__text">{{$t('DOWNLOAD_APP')}}</div>
    </div>
  </div>
  <!-- BOTTOM NAVIGATION CORDOVA -->
