<template>
  <div class="header">
    ...
    <div class="header-right">
      <div class="header-auth header__auth">
        <router-link to="/" class="header-auth__item">Войти</router-link>
        <router-link to="/" class="header-auth__item">Регистрация</router-link>
      </div>
      <q-btn color="secondary" class="header__create" label="Подать объявление"/>
    </div>
  </div>
</template>
